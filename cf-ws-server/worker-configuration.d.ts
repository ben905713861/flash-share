/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dd80f9796fd9949d6ca4e57540af5495)
...
interface __BaseEnv_Env {
	...
	PAIR_ROOM: DurableObjectNamespace<import("./src/index").PairingRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PairingRoom" | "ChatRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ROOM_KEY_SECRET">> {}
}
